...
ActiveRecord::Schema.define(version: 20170404092053) do
  ...
  create_table "attachments", force: :cascade do |t|
    ...
    t.integer  "pdf_rendered_from_html_attachment_id", limit: 4
    t.boolean  "should_render_pdf"
  end
  ...
  add_index "attachments", ["pdf_rendered_from_html_attachment_id"], name: "index_attachments_on_pdf_rendered_from_html_attachment_id", using: :btree
