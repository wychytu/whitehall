...
ActiveRecord::Schema.define(version: 20170821152429) do
  ...
  create_table "links_reports", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["link_reportable_id", "link_reportable_type"], name: "link_reportable_index"
  end
